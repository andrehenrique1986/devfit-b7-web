...
const Page = (props) => {
    ...
    switch(props.workoutDays.length){
        case 1: 
            ...
            break;
        case 2:
            funnyPhrase = '2 dias é pouco, mas quem sou eu pra te julgar?';
            break;
        case 3: 
    ...
    return(
        <Container>
            ...
            <LevelArea>
                ...
                <DefaultButton bgcolor={props.level == 'intermediate'? '#A5E8BC':false} onPress={()=>setMyLevel('intermediate')} style={{ marginBottom: 20 }}>
                    <Text>Intermediário / Me viro bem</Text>
                </DefaultButton>

                <DefaultButton bgcolor={props.level == 'advanced'? '#A5E8BC':false} onPress={()=>setMyLevel('advanced')} width={100} style={{ marginBottom: 20 }}>
